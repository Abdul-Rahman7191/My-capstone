...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Updated validation domain check
    if (!email.toLowerCase().endsWith('@ichiban.com')) {
      setError('Must use an official @ichiban.com corporate email.');
      return;
    }
